...
int main(int argc, char **argv)
{
	...
	for(i = optind; argv[i]; )
	{
		...
		//while (frames != 100) {
			...
			// copy
			source = open(argv[i], O_RDONLY, 0);
        		dest = open("/tmp/f_copy.jpg", O_TRUNC | O_WRONLY | O_CREAT, 0666);
